...
class StreamingRole(object):
    ...
    def __init__(self, bot: Red):
        ...
        self.logger = logging.getLogger("red.SepRedCogs.streamingrole")
        ...
        asyncio.ensure_future(self.__init_cache())
        asyncio.ensure_future(self.edit_streaming_role_loop())
